...
void main() {
  ...
  group('Basic Expressions', () {
    test('evaluates literal expressions correctly', () {
    ...
    test('evaluates binary expressions with arithmetic operators', () {
    ...
    test('evaluates unary expressions correctly', () {
  ...
  group('Variable Operations', () {
    test('handles variable declarations and assignments correctly', () {
    ...
    test('throws error when reassigning const or final variables', () {
      // Const variable
  ...
  group('Control Flow', () {
    test('evaluates if statements correctly', () {
    ...
    test('executes for loops correctly', () {
  ...
  group('Functions', () {
    test('handles function declarations and calls correctly', () {
    ...
    test('evaluates recursive functions (Fibonacci) correctly', () {
    ...
    test('calls functions using callFunction method', () {
  ...
  group('Data Structures and Access', () {
    test('evaluates member access on objects correctly', () {
    ...
    test('evaluates index access on arrays correctly', () {
    ...
    test('creates and evaluates list literals correctly', () {
      const expr = ListLiteral([Literal(1), Literal(2), Literal(3)]);
      expect(evaluator.evaluateNode(expr), equals([1, 2, 3]));
    });

    test('accesses length property of various types correctly', () {
    ...
    test('handles length and index access correctly', () {
      ...
      expect(
          () => evaluator.evaluateNode(expr), throwsA(isA<EvaluationError>()));
      ...
      expect(evaluator.evaluateNode(expr), equals(3));

      expr = const MemberAccess(
        Variable(Token(TokenType.identifier, 'arr', null, 1, 1)),
        Token(TokenType.identifier, 'invalid', null, 1, 1),
      );
      expect(evaluator.evaluateNode(expr), equals(null));
    });
  });

  group('Error Handling', () {
    test('executes try-catch-finally blocks correctly', () {
    ...
    test('evaluates expectDefined function correctly', () {
  ...
  group('Scoping', () {
    test('respects lexical scoping rules', () {
      // Test global scope
      evaluator.evaluateNode(const VariableDeclaration(
        Token(TokenType.tartVar, "var", null, 1, 1),
    ...
    test('handles closures correctly', () {
      // Test closure
      evaluator.evaluateNode(const FunctionDeclaration(
